 ...
 * <b>References:</b>
 * <ol>
 * <li>Ronald L. Rivest, "<a href="http://www.roxen.com/rfc/rfc1320.html"> The MD4 Message-Digest Algorithm</a>", IETF RFC-1320
 * (informational).
 * </ol>
 * 
 * <p>
 ...
 * 
 * Copyright (c) 1997 Systemics Ltd on behalf of the Cryptix Development Team. All rights reserved.
 * 
 * Fourni parce que visiblement en Java 1.6, la classe existe mais demeure inaccessible !
 */
public class MD4 extends MessageDigest implements Cloneable {
     ...
     * <p>
     * Continues an MD4 message digest operation, by filling the buffer, transform(ing) data in 512-bit message block(s), updating
     * the variables context and count, and leaving (buffering) the remaining bytes in buffer for the next update or finish.
     * 
     * @param input
     *            input block
     * @param offset
    ...
    /**
     * Completes the hash computation by performing final operations such as padding. At the return of this engineDigest, the MD
     * engine is reset.
     * 
